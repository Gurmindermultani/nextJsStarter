  ...
  return (
    <ScheduleDemoStyles>
      <Slide from='left' className="leftContainer">
        ...
        <div className="textCenter desktop">
        ...
        <div className="textCenter mobile">
          <Typography className="halfBackground" fontWeight="300" color="#212121" fontSizes={[16, 18, 22]} variant="h1" text="Discover how Leena AI"/>
          <Typography className="halfBackground" fontWeight="300" color="#212121" fontSizes={[16, 18, 22]} variant="h1" text="can help you transform"/>
        </div>
        <div className="textCenter">
        ...
        <div className="lower">
          <Typography fontSizes={[16, 16, 18]} variant="paragraph2" color="#0F72EE" text="Get insights about how Leena AI can help you with:"/>
          <ul>
            <li>
