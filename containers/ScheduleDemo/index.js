  ...
  return (
    <ScheduleDemoStyles>
      <div className="leftContainer">
        ...
        <Typography className="middleText halfBackground" fontWeight="300" color="#212121" fontSizes={[16, 18, 20]} variant="paragraph2" text="Discover how Leena AI can help you transform"/>
        <br />
        <Typography className="halfBackground" fontWeight="300" color="#212121" fontSizes={[16, 18, 20]} variant="paragraph2" text="your employee experience."/>
        <br />
