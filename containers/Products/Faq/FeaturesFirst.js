    ...
    <FeaturesFirstStyles>
      <div className="leftContainer">
        <div from='left' className="first">
          ...
          <Typography className="descriptionText" variant="paragraph2" fontSize="18px" text={"Understand your employee queries accurately and let the virtual HR assistant reply instantly."}/>
        </div>
      ...
      <div className="rightContainer">
        <div className="image center">
          <img alt="conversational employee queries" src="/images/bg.svg"/>
          <Slide from='left' className="a1">
            <img alt="conversational employee queries" src="/images/faq/featuresFirst/a1.svg"/>
          </Slide>
          <Slide from='right' className="a3">
            <img alt="conversational employee queries" src="/images/faq/featuresFirst/a3.svg"/>
          </Slide>
        </div>
      </div>
    </FeaturesFirstStyles>
